...
调参。当前最终硬门仍取决于 2026-09-04 NFP 真实当期记录能否在发布窗口内取得 BLS actual 并完成封存。
...
最终事件为 2026-09-04 发布的 2026 年 8 月美国非农就业。发布前固定根参考类期望、尺度、模型/数据
哈希、结果窗口和交易规则；发布后 15 分钟内只允许增加 BLS 官方 `root_actual/root_actual_source`。
