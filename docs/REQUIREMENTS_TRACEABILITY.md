...
本页只帮助读者定位产物。方法结论以 `reports/SUBMISSION_REPORT.md` 和机器可读结果为准。

| 内容 | 实现或结果 | 主要证据 |
|---|---|---|
| 设计定位 | 固定主链、多测量节点、诊断变量和能力边界 | `docs/EVALUATOR_GUIDE.md`、`docs/METHODOLOGY.md` |
...
| 条件链模型 | `P(E1)P(E2|E1)P(E3|E1,E2)`，共同后验采样 | `docs/METHODOLOGY.md`、`src/macro_gold_latent/model.py` |
...
| 当期演示 | 2026-09-04 NFP，预测记录早于下游日终结果 | `demo/current/NFP_202608_REL_20260904_A004.json`、`demo/runs/NFP_202608_REL_20260904_A004.md` |
| 交易动作 | 第一跳 `STOP_ABSTAIN`，最终 `NO_POSITION` | 当期演示记录、`reports/stop_trace.csv` |
| 后续追踪 | 下游 outcome 追加与六个月回查 | `demo/TRACKING_PLAN.md` |
| 负结果 | 低估、climatology 比较、日频因果边界、标签接触边界 | `docs/KNOWN_LIMITATIONS.md` |
...
完成后先看 `reports/SUBMISSION_REPORT.md`，再按上表检查 JSON/CSV 原始产物。
