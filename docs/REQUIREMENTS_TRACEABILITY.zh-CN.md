...
| 内生与外部风险 | 内生完整传导概率与外部截断 `q` 分别输出 | `reports/model_run.json`、`reports/SUBMISSION_REPORT.zh-CN.md` |
...
| CI 来源 | 参数、测量、漂移、共同 frailty、外部截断 | `reports/model_run.json`、`docs/METHODOLOGY.zh-CN.md` |
