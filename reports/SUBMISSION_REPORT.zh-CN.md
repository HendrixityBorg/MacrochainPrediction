...
- 当期记录 SHA-256：`4846ceb1e882306de2361bdac370b92e92ba53cf992b9418d8a953d4626de890`；
- 预测记录时间 `2026-09-04T14:03:26Z`，早于最早下游结果窗口完成时间 `2026-09-04T20:00:00Z`。

第一跳停止来自宽 CI 与低复核 EVSI 的组合：区间下沿不足以支持保守决策，继续一次等价复核又不足以覆盖成本。这是一次可执行的弃权，不等于模型失效；后两跳仍输出但明确标为反事实。
